describe("Preview Mode E2E - Service Worker Update", () => {
  it("should update service worker with new env values", () => {
    // Visit preview server (first load - service worker installs with NEW env values)
    cy.visit("/");
    ...
    // Verify page displays NEW interpolated value
