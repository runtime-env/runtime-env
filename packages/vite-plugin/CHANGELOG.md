...
## [0.2.0](https://github.com/runtime-env/runtime-env/compare/vite-plugin0.1.5...vite-plugin0.2.0) (2026-06-01)
...
* The following workspace dependencies were updated
  * devDependencies
    * @runtime-env/cli bumped from ^1.1.1 to ^1.1.2
  * peerDependencies
    * @runtime-env/cli bumped from * to 1.1.2

## [0.1.4](https://github.com/runtime-env/runtime-env/compare/vite-plugin0.1.3...vite-plugin0.1.4) (2026-04-01)
...
* The following workspace dependencies were updated
  * devDependencies
    * @runtime-env/cli bumped from ^1.1.0 to ^1.1.1
  * peerDependencies
    * @runtime-env/cli bumped from * to 1.1.1

## [0.1.3](https://github.com/runtime-env/runtime-env/compare/vite-plugin0.1.2...vite-plugin0.1.3) (2026-02-07)
...
* The following workspace dependencies were updated
  * devDependencies
    * @runtime-env/cli bumped from ^1.0.1 to ^1.1.0
  * peerDependencies
    * @runtime-env/cli bumped from * to 1.1.0
...
* **vite-plugin:** move @runtime-env/cli and vite to peerDependencies ([#554](https://github.com/runtime-env/runtime-env/issues/554)) ([7050511](https://github.com/runtime-env/runtime-env/commit/70505118c884f527fa4f7a2c7bf7a39e4da9d7c6))
...
* The following workspace dependencies were updated
  * devDependencies
    * @runtime-env/cli bumped from ^0.7.8 to ^1.0.0
  * peerDependencies
    * @runtime-env/cli bumped from * to 1.0.0
