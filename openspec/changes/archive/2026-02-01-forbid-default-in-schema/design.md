...
- **[Risk] Breaking Change** → Existing projects with `default` in their schema will fail to build/validate.
  - **Mitigation**: Provide a clear error message explaining _why_ it's forbidden and how to fix it (remove the keyword and use environment variables for defaults).
